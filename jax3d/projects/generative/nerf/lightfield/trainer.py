...
"""Trainer for NeRF transformer Model."""
...
from jax3d.projects.generative.nerf.lightfield import eval as evaluation
from jax3d.projects.generative.nerf.lightfield import loss
  ...
  def build_train_step(self) -> Callable[[Any], Any]:
    ...
    def per_device_train_step(model_parameters, latents, optimizer_state, data,
      ...
      def _loss_fn(params, data, rng, step):
        ...
        return loss.lightfield_loss_fn(model_parameters, inputs, data, rng,
                                       step)
  ...
  def eval_step(self, train_state: TransformerNeRFTrainState,
    ...
    if scratch is None:
      ...
      summary_data_reader = dataclasses.replace(
          self.data_reader, identity_batch_size=evaluation.EVAL_IDS_PER_BATCH)
