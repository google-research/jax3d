...
from jax3d.utils.typing import Tree  # pylint: disable=g-multiple-import
...
def xmap(
  ...
  * All additional arguments not defined in `in_axes`
  ...
  def decorated(*args, **kwargs):
    ...
    # TODO(jax3d): Remove once https://github.com/google/jax/issues/5652 is
    # fixed
    in_axes_normalized = jax.tree_map(_normalize_dict_shape, arr_args, in_axes)
